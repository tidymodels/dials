#' Same orientation for all clusters?
#'
#' Used in [tidyclust::gm_clust()].
#'
#' @details Parameter to control whether whether fitted Gaussian distributions for clusters share the same orientation in the predictor space. Only applicable if `circular == FALSE` and `zero_covariance == FALSE`.
#'
