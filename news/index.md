...
- [`value_validate()`](https://dials.tidymodels.org/reference/value_validate.md),
  ...
  and
  [`get_batch_sizes()`](https://dials.tidymodels.org/reference/get_batch_sizes.md)
...
- [`parameters.list()`](https://dials.tidymodels.org/reference/parameters.md)
...
- Added three new parameters for use in postprocessing in the tailor
  ...
  - [`buffer()`](https://dials.tidymodels.org/reference/buffer.md) sets
    the distance on either side of a classification threshold within
    which predictions are considered equivocal in
...
- The `grid_*()` functions now error instead of warn when provided with
  ...
  [`grid_max_entropy()`](https://dials.tidymodels.org/reference/grid_max_entropy.md),
  and
  [`grid_latin_hypercube()`](https://dials.tidymodels.org/reference/grid_max_entropy.md)
...
- Added
  [`num_runs()`](https://dials.tidymodels.org/reference/num_runs.md) for
  `recipes::step_nnmf()`
...
- The new parameter
  ...
  is a variation on
  [`mtry()`](https://dials.tidymodels.org/reference/mtry.md) where the
  value is interpreted as the proportion (rather than the count) of
...
- The range for
  [`epochs()`](https://dials.tidymodels.org/reference/dropout.md) was
  change to start at 10 iterations instead of 1.
...
- The upper range for
  [`cost()`](https://dials.tidymodels.org/reference/cost.md) now goes to
  `2^5` instead of `2^-1`.
...
- The range for
  [`num_hash()`](https://dials.tidymodels.org/reference/texthash.md) was
  increase to be `2^8` to `2^12`.
...
- All parameter *objects* are now parameter *functions*. For example,
  ...
  [`mtry()`](https://dials.tidymodels.org/reference/mtry.md), with
...
- Parameters
  ...
  and [`degree_int()`](https://dials.tidymodels.org/reference/degree.md)
  were added.
