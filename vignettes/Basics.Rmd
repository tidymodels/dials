...
The package contains two constructors that can be used to create new quantitative and qualitative parameters. [This file](https://github.com/topepo/dials/blob/master/R/parameters.R) contains the code to create the parameters contained in the package. 
...
Sets or combinations or parameters can be created for use in grid search. `regular_grid` and `random_grid` take any number of `param` objects. 
